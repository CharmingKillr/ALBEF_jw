...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='/data/jw/projects/ALBEF_jw/configs/VE.yaml')
    parser.add_argument('--output_dir', default='/data/jw/projects/ALBEF_jw/output/VE')  
